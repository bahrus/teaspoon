...
namespace CurlyBraceParser
{
    ...
    [AutoGenerateDefaultCSharpImplementation]
    public interface IDataElement : ISignatureElement, IHaveHelpText
    {
        string Name { get; set; }
    ...
    [AutoGenerateDefaultCSharpImplementation]
    public interface IInterface : IOpenBraceStatement, IHaveAccessModifier, IOpenBraceContainer, IHaveHelpText
    {
    ...
    [AutoGenerateDefaultCSharpImplementation]
    public interface IField : IDataElement
    {
